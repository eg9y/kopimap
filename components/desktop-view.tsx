        ...
        <AnimatePresence>
          <Suspense fallback={<CafeDetailsLoader />}>
            <>
              <motion.div
                className={
                  "ml-[330px] z-10 h-[calc(100%_-_56px_-0.5rem)] min-w-[400px] w-[30vw] overflow-y-scroll pointer-events-auto bg-slate-50 absolute ring-1 ring-slate-300 shadow-md flex flex-col gap-2"
                }
                animate={{
                  width: "30vw",
                  minWidth: "500px",
