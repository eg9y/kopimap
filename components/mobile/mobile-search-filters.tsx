...
export const MobileSearchFilters: React.FC = () => {
  ...
  return (
    <div className="flex-grow overflow-x-auto scrollbar-hide touch-pan-x pr-10">
      <div className="flex space-x-3 ">
        {/* Rating filter */}
        <Dropdown>
          <DropdownButton className="flex items-center rounded-lg py-2 !px-1 text-sm font-medium shadow-md transition-all duration-200 ease-in-out bg-yellow-100 text-yellow-700 hover:bg-yellow-200">
        ...
        <Dropdown>
          <DropdownButton className="flex items-center rounded-lg py-2 !px-1 text-sm font-medium shadow-md transition-all duration-200 ease-in-out bg-purple-100 text-purple-700 hover:bg-purple-200">
        ...
        {filterButtons.map((button) => {
          ...
          return (
            <button
              ...
              className={`flex items-center space-x-2 rounded-lg py-2 px-1 text-sm font-medium shadow-md transition-all duration-200 ease-in-out ${
                isActive
