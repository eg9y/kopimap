...
export function SidebarLayout({
  ...
  return (
    <div className="relative isolate flex min-h-svh w-full bg-white max-lg:flex-col lg:bg-zinc-100 dark:bg-zinc-900 dark:lg:bg-zinc-950">
      {/* Sidebar on desktop */}
      <div className="fixed inset-y-0 left-0 w-[500px] max-lg:hidden">{sidebar}</div>
      ...
      {/* Content */}
      <main className="flex flex-1 flex-col pb-2 lg:min-w-0 lg:pl-[500px] lg:pr-2 lg:pt-2 h-[100vh]">
        <div className="grow lg:rounded-lg lg:bg-white  lg:shadow-sm lg:ring-1 lg:ring-zinc-950/5 h-full dark:lg:bg-zinc-900 dark:lg:ring-white/10">
